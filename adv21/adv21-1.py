...
def does_win(items_choice, weapons_dict, armor_dict, rings_dict, boss_stats_orig, you_stats_orig):
    ...
    while(True):
        ...
        if(turn == "player"):
            damage_dealt = you_damage - boss_armor
            ...
            damage_dealt = boss_damage - you_armor
...
for number_choice in numbers:
    ...
    for items_choice in items_choice_list:
        ...
        if(does_win(items_choice, weapons_dict, armor_dict, rings_dict, boss_stats_orig, you_stats_orig)):
