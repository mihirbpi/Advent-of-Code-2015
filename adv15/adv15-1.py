...
for i in range(0, len(my_list)):
    ...
    ingredient, capacity, durability, flavor, texture = [match.group(x) for x in range(1, 6)]
    ingredients.append(ingredient)
    ingredient_info_dict[ingredient] = list(map(int, [capacity, durability, flavor, texture]))
