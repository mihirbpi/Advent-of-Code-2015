...
orig_wire_values_dict = copy.deepcopy(wire_values_dict)
...
result_a = get_signal("a", wire_operations_dict, wire_values_dict)
orig_wire_values_dict["b"] = result_a
print(get_signal("a", wire_operations_dict, orig_wire_values_dict))
